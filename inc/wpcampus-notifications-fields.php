	...
	if ( function_exists( 'acf_add_local_field_group' ) ) :
		...
		acf_add_local_field_group(array(
			...
			'fields' => array(
				...
				array(
					'key' => 'field_5b2430c0874d9',
					'label' => sprintf( __( '%s message', 'wpc-notifications' ), 'Twitter' ),
					'name' => 'twitter_message',
					'type' => 'wysiwyg',
					'instructions' => __( 'What message do you want to share on Twitter?', 'wpc-notifications' ),
					'required' => 0,
					'conditional_logic' => 0,
					'default_value' => '',
					'tabs' => 'text',
				...
				array(
					'key' => 'field_5b2466680abec',
					'label' => sprintf( __( '%s message', 'wpc-notifications' ), 'Facebook' ),
					'name' => 'facebook_message',
					'type' => 'wysiwyg',
					'instructions' => sprintf( __( 'What message do you want to share on %s?', 'wpc-notifications' ), 'Facebook' ),
					'required' => 0,
					'conditional_logic' => 0,
					'default_value' => '',
					'tabs' => 'text',
				...
				array(
					'key' => 'field_5b2603c6aa42f',
					'label' => sprintf( __( '%s message', 'wpc-notifications' ), 'Slack' ),
					'name' => 'slack_message',
					'type' => 'textarea',
					'instructions' => sprintf( __( 'What message do you want to share on %s?', 'wpc-notifications' ), 'Slack' ),
					'required' => 0,
					'conditional_logic' => 0,
					'default_value' => '',
					'placeholder' => '',
